...
Primeiramente, criaremos uma nova variável, onde essa ira receber o valor "1" (string) se a variável "Evolucao" for igual a "Óbito pelo COVID-19" e se for diferente ira receber o valor "0" 
...
Pronto, o próximo passo é criar um DataFrame que ira receber as variáveis que queremos analisar, nesse caso, "Sexo", "RacaCor" e "prop". Aqui já iremos calcular a taxa de letalidade.
