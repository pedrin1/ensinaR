...
ggplot(dados) + geom_bar(aes(x=RacaCor, fill= RacaCor)) + scale_y_continuous(breaks = seq(0,100000,2500)) +
...
```{r}
ggplot(dados2) + geom_bar(aes(x=região,fill=região)) + scale_y_continuous(breaks = seq(0,100000, 10000)) +
  labs(y="Frequência") + theme_bw() 
...
ggplot(regiao_m) + geom_bar(aes(RacaCor, fill=Sexo), position = "dodge") + scale_y_continuous(breaks = seq(0,100000,2500)) +
